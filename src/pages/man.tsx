...
export default function Man({ sneakers }: ManProps) {
  return (
    <main>
      <div className="container pt-14 main-height">
        <h1 className="text-5xl font-bold text-center text-gray-900">
          Confira nossos modelos disponíveis
        </h1>

        <section className="grid grid-cols-4 mt-16 gap-14 pb-14">
