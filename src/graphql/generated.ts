...
/** Asset system model */
export type AssetImageSneakerArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  forceParentLocale?: InputMaybe<Scalars['Boolean']>;
...
export type AssetCreateInput = {
  ...
  imageSneaker?: InputMaybe<SneakerCreateManyInlineInput>;
...
export type AssetManyWhereInput = {
  ...
  imageSneaker_every?: InputMaybe<SneakerWhereInput>;
  imageSneaker_none?: InputMaybe<SneakerWhereInput>;
  imageSneaker_some?: InputMaybe<SneakerWhereInput>;
...
export type AssetUpdateInput = {
  ...
  imageSneaker?: InputMaybe<SneakerUpdateManyInlineInput>;
...
export type Mutation = {
  ...
  /** Delete one sneaker from _all_ existing stages. Returns deleted document. */
...
export type OrderUpdateInput = {
  email?: InputMaybe<Scalars['String']>;
  product?: InputMaybe<Scalars['Json']>;
  stripeId?: InputMaybe<Scalars['String']>;
};
...
export type Query = {
  ...
  /** Retrieve multiple sneakers */
  sneakers: Array<Sneaker>;
  /** Retrieve multiple sneakers using the Relay connection interface */
...
export type ScheduledOperationAffectedDocument = Asset | Brand | Category | Order | Review | Sneaker;
...
export type Sneaker = Node & {
  __typename?: 'Sneaker';
  brand?: Maybe<SneakerBrand>;
  category?: Maybe<SneakerCategory>;
  /** The time the document was created */
  createdAt: Scalars['DateTime'];
  /** User that created this document */
  createdBy?: Maybe<User>;
...
export type SneakerBrand = Brand;

export type SneakerBrandConnectInput = {
  Brand?: InputMaybe<BrandConnectInput>;
};

export type SneakerBrandCreateInput = {
  Brand?: InputMaybe<BrandCreateInput>;
};

export type SneakerBrandCreateManyInlineInput = {
  /** Connect multiple existing SneakerBrand documents */
  connect?: InputMaybe<Array<SneakerBrandWhereUniqueInput>>;
  /** Create and connect multiple existing SneakerBrand documents */
  create?: InputMaybe<Array<SneakerBrandCreateInput>>;
};

export type SneakerBrandCreateOneInlineInput = {
  /** Connect one existing SneakerBrand document */
  connect?: InputMaybe<SneakerBrandWhereUniqueInput>;
  /** Create and connect one SneakerBrand document */
  create?: InputMaybe<SneakerBrandCreateInput>;
};

export type SneakerBrandUpdateInput = {
  Brand?: InputMaybe<BrandUpdateInput>;
};

export type SneakerBrandUpdateManyInlineInput = {
  /** Connect multiple existing SneakerBrand documents */
  connect?: InputMaybe<Array<SneakerBrandConnectInput>>;
  /** Create and connect multiple SneakerBrand documents */
  create?: InputMaybe<Array<SneakerBrandCreateInput>>;
  /** Delete multiple SneakerBrand documents */
  delete?: InputMaybe<Array<SneakerBrandWhereUniqueInput>>;
  /** Disconnect multiple SneakerBrand documents */
  disconnect?: InputMaybe<Array<SneakerBrandWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing SneakerBrand documents */
  set?: InputMaybe<Array<SneakerBrandWhereUniqueInput>>;
  /** Update multiple SneakerBrand documents */
  update?: InputMaybe<Array<SneakerBrandUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple SneakerBrand documents */
  upsert?: InputMaybe<Array<SneakerBrandUpsertWithNestedWhereUniqueInput>>;
};

export type SneakerBrandUpdateManyWithNestedWhereInput = {
  Brand?: InputMaybe<BrandUpdateManyWithNestedWhereInput>;
};

export type SneakerBrandUpdateOneInlineInput = {
  /** Connect existing SneakerBrand document */
  connect?: InputMaybe<SneakerBrandWhereUniqueInput>;
  /** Create and connect one SneakerBrand document */
  create?: InputMaybe<SneakerBrandCreateInput>;
  /** Delete currently connected SneakerBrand document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Disconnect currently connected SneakerBrand document */
  disconnect?: InputMaybe<Scalars['Boolean']>;
  /** Update single SneakerBrand document */
  update?: InputMaybe<SneakerBrandUpdateWithNestedWhereUniqueInput>;
  /** Upsert single SneakerBrand document */
  upsert?: InputMaybe<SneakerBrandUpsertWithNestedWhereUniqueInput>;
};

export type SneakerBrandUpdateWithNestedWhereUniqueInput = {
  Brand?: InputMaybe<BrandUpdateWithNestedWhereUniqueInput>;
};

export type SneakerBrandUpsertWithNestedWhereUniqueInput = {
  Brand?: InputMaybe<BrandUpsertWithNestedWhereUniqueInput>;
};

export type SneakerBrandWhereInput = {
  Brand?: InputMaybe<BrandWhereInput>;
};

export type SneakerBrandWhereUniqueInput = {
  Brand?: InputMaybe<BrandWhereUniqueInput>;
};

export type SneakerCategory = Category;

export type SneakerCategoryConnectInput = {
  Category?: InputMaybe<CategoryConnectInput>;
};

export type SneakerCategoryCreateInput = {
  Category?: InputMaybe<CategoryCreateInput>;
};

export type SneakerCategoryCreateManyInlineInput = {
  /** Connect multiple existing SneakerCategory documents */
  connect?: InputMaybe<Array<SneakerCategoryWhereUniqueInput>>;
  /** Create and connect multiple existing SneakerCategory documents */
  create?: InputMaybe<Array<SneakerCategoryCreateInput>>;
};

export type SneakerCategoryCreateOneInlineInput = {
  /** Connect one existing SneakerCategory document */
  connect?: InputMaybe<SneakerCategoryWhereUniqueInput>;
  /** Create and connect one SneakerCategory document */
  create?: InputMaybe<SneakerCategoryCreateInput>;
};

export type SneakerCategoryUpdateInput = {
  Category?: InputMaybe<CategoryUpdateInput>;
};

export type SneakerCategoryUpdateManyInlineInput = {
  /** Connect multiple existing SneakerCategory documents */
  connect?: InputMaybe<Array<SneakerCategoryConnectInput>>;
  /** Create and connect multiple SneakerCategory documents */
  create?: InputMaybe<Array<SneakerCategoryCreateInput>>;
  /** Delete multiple SneakerCategory documents */
  delete?: InputMaybe<Array<SneakerCategoryWhereUniqueInput>>;
  /** Disconnect multiple SneakerCategory documents */
  disconnect?: InputMaybe<Array<SneakerCategoryWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing SneakerCategory documents */
  set?: InputMaybe<Array<SneakerCategoryWhereUniqueInput>>;
  /** Update multiple SneakerCategory documents */
  update?: InputMaybe<Array<SneakerCategoryUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple SneakerCategory documents */
  upsert?: InputMaybe<Array<SneakerCategoryUpsertWithNestedWhereUniqueInput>>;
};

export type SneakerCategoryUpdateManyWithNestedWhereInput = {
  Category?: InputMaybe<CategoryUpdateManyWithNestedWhereInput>;
};

export type SneakerCategoryUpdateOneInlineInput = {
  /** Connect existing SneakerCategory document */
  connect?: InputMaybe<SneakerCategoryWhereUniqueInput>;
  /** Create and connect one SneakerCategory document */
  create?: InputMaybe<SneakerCategoryCreateInput>;
  /** Delete currently connected SneakerCategory document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Disconnect currently connected SneakerCategory document */
  disconnect?: InputMaybe<Scalars['Boolean']>;
  /** Update single SneakerCategory document */
  update?: InputMaybe<SneakerCategoryUpdateWithNestedWhereUniqueInput>;
  /** Upsert single SneakerCategory document */
  upsert?: InputMaybe<SneakerCategoryUpsertWithNestedWhereUniqueInput>;
};

export type SneakerCategoryUpdateWithNestedWhereUniqueInput = {
  Category?: InputMaybe<CategoryUpdateWithNestedWhereUniqueInput>;
};

export type SneakerCategoryUpsertWithNestedWhereUniqueInput = {
  Category?: InputMaybe<CategoryUpsertWithNestedWhereUniqueInput>;
};

export type SneakerCategoryWhereInput = {
  Category?: InputMaybe<CategoryWhereInput>;
};

export type SneakerCategoryWhereUniqueInput = {
...
export type SneakerCreateInput = {
  brand?: InputMaybe<SneakerBrandCreateOneInlineInput>;
  category?: InputMaybe<SneakerCategoryCreateOneInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  description: Scalars['String'];
  image: AssetCreateOneInlineInput;
  isFeatured: Scalars['Boolean'];
...
export type SneakerUpdateManyInlineInput = {
  ...
  /** Create and connect multiple Sneaker documents */
  create?: InputMaybe<Array<SneakerCreateInput>>;
  /** Delete multiple Sneaker documents */
  delete?: InputMaybe<Array<SneakerWhereUniqueInput>>;
  /** Disconnect multiple Sneaker documents */
  disconnect?: InputMaybe<Array<SneakerWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing Sneaker documents */
  set?: InputMaybe<Array<SneakerWhereUniqueInput>>;
  /** Update multiple Sneaker documents */
  update?: InputMaybe<Array<SneakerUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple Sneaker documents */
...
export type SneakerUpdateOneInlineInput = {
  /** Connect existing Sneaker document */
  connect?: InputMaybe<SneakerWhereUniqueInput>;
  /** Create and connect one Sneaker document */
  create?: InputMaybe<SneakerCreateInput>;
  /** Delete currently connected Sneaker document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Disconnect currently connected Sneaker document */
  disconnect?: InputMaybe<Scalars['Boolean']>;
  /** Update single Sneaker document */
  update?: InputMaybe<SneakerUpdateWithNestedWhereUniqueInput>;
  /** Upsert single Sneaker document */
...
/** References Sneaker record uniquely */
...
export type CreateOrderMutation = { __typename?: 'Mutation', createOrder?: { __typename?: 'Order', product: any, stripeId: string } | null };
...
export type GetSneakerBySlugQuery = { __typename?: 'Query', sneaker?: { __typename?: 'Sneaker', id: string, name: string, description: string, price: number, isFeatured: boolean, slug: string, image: { __typename?: 'Asset', url: string } } | null };
...
export const CreateOrderDocument = gql`
    mutation CreateOrder($product: Json!, $stripeId: String!) {
  createOrder(data: {stripeId: $stripeId, product: $product}) {
    product
    stripeId
  }
}
...
export function useGetSneakerBySlugQuery(options: Omit<Urql.UseQueryArgs<GetSneakerBySlugQueryVariables>, 'query'>) {
...
export function useGetSneakersQuery(options?: Omit<Urql.UseQueryArgs<GetSneakersQueryVariables>, 'query'>) {
  return Urql.useQuery<GetSneakersQuery, GetSneakersQueryVariables>({ query: GetSneakersDocument, ...options });
};